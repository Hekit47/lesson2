...
public class main {
        ...
        public static void massivZamenaZnacheniy()
        {
            ...
            for (int k = 0; k < arr.length; k ++)   // запускаем перебор в рамках массива
            {
                ...
                else arr[k] = 1;                    //если условие не выполняется, то присваиваем переменной другое значение 1
       ...
       public static void moveArray ()
       {
           ...
           if (move >= 0 && move <= arr.length)
           {
               ...
               for (int j = arr.length - 1; j >= move; j--) {
                   arr[j] = arr[j - move];
               }
               // обнуляем значение, которые в диапазоне сдвига
           ...
           else if (move < 0 && move * -1 <= arr.length)
           {
               move = move * -1;
               ...
               for (int j = arr.length - 1; j > arr.length -1 - move; j --)
               {
                   arr[j] = 0;
               }
           ...
           {
               // если сдвиг больше размера массива, то все значения массива равны 0, т.к. сдвинулись за массив
               for (int d = 0; d < arr.length; d++)
               {
                   arr[d] = 0;
                   System.out.print(arr[d]);
